...
export default function VerifierRegistration() {
  ...
  if (!registrationIsActive) {
    return (
      <div className="vr-reg-page">
        <div className="vr-reg-page__accent" aria-hidden />
        <Dialog open onClose={handleClosedDialogClose} maxWidth="sm" fullWidth>
        ...
        <div className="vr-reg-header__inner">
          ...
          <div className="vr-reg-header__brand">
            ...
            <div className="vr-reg-header__brand-text">
              ...
              <p className="vr-reg-header__org-en">Gujarat - SSSA</p>
            </div>
            <img
              src={GsqacLogoImg}
              alt="GSQAC"
          ...
          <Paper elevation={0} className="vr-reg-card">
            <Box className="vr-reg-card__letterhead">
              ...
              <p className="vr-reg-card__sub">
                નીચેની વિગતો સંપૂર્ણ અને સચોટ ભરો. તારાંકિત (*) ક્ષેત્રો
                અનિવાર્ય છે.
                <span>
            ...
            >
              ...
              >
                <strong>નોંધ / Note:</strong> નોંધણી માટે જે મોબાઈલ નંબરનો ઉપયોગ
                કરશો તેજ મોબાઇલ નંબર વેરિફાયર ના આઈ.ડી માં ઉપયોગ માં લેવાશે એટલે
                કે એક ફોન નંબરથી માત્ર એક જ વાર ફોર્મ ભરી શકાશે. એક વાર નોંધણી
                થયા પછી એ જ મોબાઈલ નંબરથી ફરીથી નોંધણી કરી શકાશે નહીં.
                <span>
                  The mobile number used for registration will also be used as
                  the Verifier ID, so the form can be filled only once with one
                  phone number. After registration, the same mobile number
                  cannot be used to register again.
                </span>
              </Typography>
              ...
              >
                ...
                >
                  <FormLabel className="vr-reg-checkbox-group__label">
                    ...
                    <span className="vr-reg-optional">
                      (વૈકલ્પિક / Optional)
                    </span>
                  </FormLabel>
                    ...
                    {PROFESSIONAL_QUALIFICATIONS.map((item) => (
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            size="small"
                            checked={form.professionalQualifications.includes(
                              item.value,
                            )}
                            onChange={() =>
                              toggleMultiValue("professionalQualifications")(
                                item.value,
                              )
                            }
                          />
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ mb: 0.5 }}
                  >
                    ગુજરાતી અને અંગ્રેજીમાં વાંચન / લેખન ક્ષમતા — Reading /
                    writing ability in Gujarati &amp; English
                  </Typography>
                  <Box className="vr-reg-checkbox-group">
                      ...
                      <FormControlLabel
                        ...
                        control={
                          <Checkbox
                            ...
                            onChange={() =>
                              toggleMultiValue("languageSkills")(item.value)
                            }
                          />
                        }
                        label={formatBilingualOption(item)}
              ...
              >
                ...
                <Box className="vr-reg-grid vr-reg-grid--2">
                  ...
                  <TextField
                    ...
                    helperText={
                      errors.experienceMonths || "0–11 મહિના / months"
                    }
                  />
                </Box>
                ...
                {form.specialEducationalAchievement === "yes" && (
                  <>
                    ...
                    <Box className="vr-reg-file-field">
                      <Typography
                        variant="body2"
                        className="vr-reg-file-field__label"
                      >
                ...
                {form.previousAccreditationWork === "yes" && (
                  <TextField
                    ...
                    helperText={
                      errors.previousAccreditationDuration ||
                      "Digits only (1–60 years)"
                    }
                  />
                )}
              ...
              >
                <Typography
                  ...
                  className="vr-reg-section-note vr-reg-section-note--emphasis"
                >
                  <strong>નોંધ / Note:</strong> આ માહિતીનો હેતુ વેરિફિકેશન માટે
                  શાળા ફાળવણીને વધુ સુગમ બનાવવાનો છે. પરંતુ તમે પસંદ કરેલ
                  જિલ્લાઓ અને તાલુકાઓમાં જ શાળાઓ ફાળવાય તે જરૂરી નથી.
                  <span>
                    This information is only to make school allocation for
                    verification smoother. It is not necessary that schools will
                    be allotted only in your selected districts and talukas.
                  </span>
                  <span className="vr-reg-section-note__sub">
                    દરેક જિલ્લો ફક્ત એક વાર પસંદ કરી શકાય. એક જિલ્લામાંથી 3
                    બ્લોક / તાલુકા પસંદ કરી શકો છો (કુલ મહત્તમ 9). અન્ય જિલ્લા
                    માટે &quot;કોઈ નહીં / None&quot; પસંદ કરો. Each district can
                    be selected only once. You can select up to 3 blocks/talukas
                    per district (max 9 total). Use &quot;None&quot; for unused
              ...
              >
                <TextField
                  ...
                  helperText={
                    ...
                    "12-digit Aadhaar for identity verification"
                  }
                />
                ...
                <Typography variant="body2" className="vr-reg-section-note">
                  આ માહિતી માત્ર વેરિફિકેશનની કામગીરી માટે નાણાકીય ચૂકવણીના હેતુ
                  માટે છે.
                  <span>
                    This information is only for monetary payment related to
                    verification work.
                  </span>
                </Typography>
              ...
              >
                <FormControl
                  ...
                  required
                  className="vr-reg-declaration-box"
                >
                  <FormControlLabel
                    control={
                      <Checkbox
                    ...
                    label={
                      <Typography
                        variant="body2"
                        className="vr-reg-declaration"
                      >
                        હું બાંહેધરી આપું છું કે મારા વિરુદ્ધ કોઈ વિભાગીય તપાસ,
                        શિસ્ત વિષયક તપાસ કે કોર્ટ કેસ પેન્ડિંગ નથી. *
                        <br />
                        <span>
                          I declare that no departmental inquiry, disciplinary
                          action, or court case is pending against me.
                        </span>
                      </Typography>
                    }
                  />
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Typography
                        ...
                        className="vr-reg-declaration"
                      >
                        હું મારી સ્વેચ્છાએ આ કામગીરીમાં જોડાવા ઈચ્છું છું. *
                        <br />
                        <span>
              ...
              <Box className="vr-reg-actions">
                <div className="vr-reg-actions__note">
                  <strong>નોંધ / Note:</strong> અરજી કર્યાથી વેરિફાયર તરીકે
                  પસંદગી કે કામગીરી માટેનો કોઈ હક કે દાવો કરી શકાશે નહીં.
                  પસંદગીનો અંતિમ નિર્ણય GCERT-GSQAC નો રહેશે.
                  <span>
                    Submitting an application does not create any right or claim
                    to selection or work as a verifier. The final decision rests
                    with GCERT-GSQAC.
                  </span>
                </div>
            ...
            <footer className="vr-reg-card__footer">
              <p>
                ગુજરાત સ્કૂલ ક્વોલિટી એક્રેડિટેશન કાઉન્સિલ (GSQAC) — Gujarat -
                SSSA
              </p>
              <p>
