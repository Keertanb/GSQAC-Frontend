...
export function AdminDashboardPageView({ c }) {
  ...
  const hasSelfAssessmentData =
    selfAssessmentTotal > 0 || selfAssessmentSlotTotal > 0;
  ...
  return (
    <div className="admin-dashboard-overview">
      ...
      {/* School self-assessment session counts */}
      <section className="ado-metrics-band" aria-label="School self-assessment progress">
